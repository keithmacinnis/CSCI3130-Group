                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            ...
                            if (task.getException() instanceof FirebaseAuthUserCollisionException) {
                                Toast.makeText(ProfileActivity.this, "This email is already in use. Please try again", Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(ProfileActivity.this, "Authenitifcation failed",
